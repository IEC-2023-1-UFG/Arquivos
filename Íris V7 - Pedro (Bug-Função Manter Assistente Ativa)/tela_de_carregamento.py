...
class TimerApp:
    def __init__(self, root, tempo_para_fechar):
        ...
        self.image = Image.open(r"H:\Meu Drive\UFG\1º Período\Introdução à engenharia de computação\Projeto final\Íris V7\logo_ufg.png")

        self.image2 = Image.open(r"H:\Meu Drive\UFG\1º Período\Introdução à engenharia de computação\Projeto final\Íris V7\iris_carregamento.png")
        ...
        root.title("Universidade Federal de Goiás (UFG)")
        ...
        imagem_redimensionada2 = self.image2.resize((250, 145), Image.ANTIALIAS)
        ...
        self.widget_imagem2.place(x=120, y=30)
